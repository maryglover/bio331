...
In this lesson, we will continue working with the water quality data from the City of Raleigh. Making graphs is a great way to explore the data. This data set has already by cleaned up for you and put into the tidy data format.
...
- Homework is the climate graphs
