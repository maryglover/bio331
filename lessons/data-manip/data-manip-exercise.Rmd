...
### Recode
A more complicated, but common, edit is to change the contents of a cell. This is helpful for editing typos or making varaiables consistent. 
...
You will *not* be assessed on the `recode()` function, but it may come in handy!
