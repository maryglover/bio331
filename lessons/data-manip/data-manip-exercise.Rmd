...
1. Take a look at the first few rows to see what the data look like using `head()`
1. Use the function `nrow()` on the data to see how many observations are in the dataset
...
4. Use `select` to only show the following columns. Resave the data with only the selected columns by assigning it a new name. *You can use this new data frame for the rest of the assignment*. Select columns
- year
- title
- budget
- intgross
