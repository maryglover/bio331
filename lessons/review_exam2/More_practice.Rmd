...
1. Join the two data sets to include *only* names that are found in *both* data frames. 
<details>
  <summary>Answer</summary>
    ```{r, eval = F}
band_instruments |>
...
1. Join the two data sets to include *only* names that are found in the `band_instruments` data frames. 
<details>
  <summary>Answer</summary>
    ```{r, eval = F}
band_instruments |>
...
1. Join the two data sets to include *only* names that are found in the `band_members` data frames. 
<details>
  <summary>Answer</summary>
    ```{r, eval = F}
band_instruments |>
